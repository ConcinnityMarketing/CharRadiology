...
namespace EnvoyService.Core
{
    public abstract class Expander
    {
        ...
        public virtual bool ExpandCommunication()
        {
            bool retbool = false;
            return retbool;
        }
    ...
    public class CRADExpander : Expander
    {
        public CRADExpander()
        {

        }
        public CRADExpander(ISessionFactory sessionFactory)
        {
            Expander.sessionFactory = sessionFactory;
        }
        public override bool ExpandCommunication()
        {
            bool retbool = false;
